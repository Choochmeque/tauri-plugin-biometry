...
// COM method names match the Windows ABI verbatim; macro-generated cast
// expansion uses reference-to-reference transmute as part of the
// IUnknown-derived vtable plumbing.
...
unsafe trait IUserConsentVerifierInterop: windows_core::IUnknown {
    unsafe fn GetIids(&self, iid_count: *mut u32, iids: *mut *mut GUID) -> HRESULT;
    unsafe fn GetRuntimeClassName(
        &self,
        class_name: *mut std::mem::ManuallyDrop<HSTRING>,
    ) -> HRESULT;
    unsafe fn GetTrustLevel(&self, trust_level: *mut i32) -> HRESULT;
